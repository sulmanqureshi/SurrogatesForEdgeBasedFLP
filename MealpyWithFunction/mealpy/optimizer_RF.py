...
class Optimizer:
    ...
    def __init__(self, problem, kwargs=None):
        ...
        self.n_estimators = 100  # int
        self.criterion = "squared_error"  # “squared_error”, “absolute_error”, “poisson”
        ...
        self.max_features = 0.3  # “sqrt”, “log2”, None/1.0{0.3 for more randomness}
    ...
    def evaluate_pop_mix_10_per(self, modelRF, pop):
        ...
        for epoch in range(0, self.epoch):
            ...
            if epoch <= 2:
                ...
                if epoch == 3:
                    ...
                    self.n_estimators = trial.params['n_estimators']
                    self.criterion = trial.params['criterion']
                    self.max_features = trial.params['max_features']

                modelRF = RandomForestRegressor(n_estimators=self.n_estimators, criterion=self.criterion,
                                                max_features=self.max_features)

                modelRF.fit(df_pop, df_cost.values.ravel())

                cost_real, pop_real, cost, population, mse, accuracy_ = \
                    self.evaluate_pop_mix_10_per(modelRF, population)
                rmse.append(mse)
